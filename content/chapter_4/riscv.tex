...
The \emph{saved} registers \qVerb{s1}-\qVerb{s11} are meant to be preserved across function calls, that is, a called function must not overwrite them.
...
The other `\Verb{fa}$n$' registers (\qVerb{fa2}--\qVerb{fa7}) are meant to be used as float function arguments.
