...
For instance, the first two arguments of the rush function call `\LirstInline{rush}{foo(40, 2, 3.14)}' would be placed in the registers \qVerb{a0} and \qVerb{a1}.
