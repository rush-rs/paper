...
\Lirsting[ranges={1-30}, raw queries=true, caption={LLVM IR Representation of the Program in Listing~\ref{lst:rush_fib}}, label={lst:llvm_fib}, float=H]{listings/generated/fib.ll}
...
In line 11, of the `\texttt{merge}' block, the `\texttt{phi}' instruction is used.
