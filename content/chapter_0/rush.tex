\newpage
\section{Characteristics of The rush Programming Language} % TODO: is capitalization correct?
...
This function accepts the paramter \texttt{n}, it denotes the position of the number to be calculated.
...
The if-else construct must also be an expression since it is used like a value in this example.
