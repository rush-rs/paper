...
It then first matches on the current token kind to decide which expression to parse and stores the result in the \qVerb{lhs}\footnote{Short for `left-hand side'} variable.
