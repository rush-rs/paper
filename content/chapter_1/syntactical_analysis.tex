...
\Lirsting[ranges={10-16}, path prefix={deps/rush}, wrap=L, wrap width=0.4\textwidth, caption={The rush \qVerb{Lexer} Struct Definition}, label={lst:lexer}]{deps/rush/crates/rush-parser/src/lexer.rs}
...
\Lirsting[ranges={172-173, 194-201}, path prefix={deps/rush}, float=h, label={lst:rush_tok_prec}, caption={Token Precedences in rush}]{deps/rush/crates/rush-parser/src/token.rs}
...
\Lirsting[ranges={551-555, 568-570, _574-583, 613-618}, path prefix={deps/rush}, float=h, label={lst:pratt_expr}, caption={Pratt-Parser: Implementation for Expressions}]{deps/rush/crates/rush-parser/src/parser.rs}

\Lirsting[ranges={733-743, 749-749}, path prefix={deps/rush}, float=h, label={lst:pratt_grouped_expr}, caption={Pratt-Parser: Implementation for Grouped Expressions}]{deps/rush/crates/rush-parser/src/parser.rs}
...
\Lirsting[ranges={751-751, _756-759, 770-770}, path prefix={deps/rush}, float=h, label={lst:pratt_infix_expr}, caption={Pratt-Parser: Implementation for Infix Expressions}]{deps/rush/crates/rush-parser/src/parser.rs}
...
Starting from the left, the parser first encounters \textcolor{red}{a/an} `\Verb{LParen}' token and therefore decides to parse a `\Verb{grouped_expr}'.
