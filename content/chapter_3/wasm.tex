...
\Lirsting[ranges={11-15, 26-31, 37-39, 58-58}, float=h, label={lst:wasm_compiler}, caption={\qVerb{Compiler} Struct Definition of the WebAssembly Compiler}]{deps/rush/crates/rush-compiler-wasm/src/compiler.rs}
...
\Lirsting[ranges={758-779, _796-798, 864-864}, wrap=o, wrap width=0.7\textwidth, fancyvrb={numbers=\OuterEdge}, label={lst:wasm_logical_infix}, caption={Compilation of logical operators.}]{deps/rush/crates/rush-compiler-wasm/src/compiler.rs}
