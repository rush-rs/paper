...
The instructions in Figure~\ref{fig:tree_vs_vm_vm} can be interpreted by the rush VM\@.
...
In order to improve efficiency, an algorithm could traverse the AST once, saving its semantic meaning in the%
