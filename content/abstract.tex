\begin{abstract}
	...
	Therefore, we have implemented rush using one interpreter, one virtual machine, one transpiler, and five compilers.
	...
	Chapter 4 illustrates how compilation to high-level\footnote{\emph{High-level} targets: in this case machine independent; many abstractions are provided.} targets works.
	...
	Chapter 5 focuses on how compilers targeting low-level\footnote{\emph{Low-level} targets: specific to one physical target architecture and operating system; little abstraction is provided.} architectures can be implemented.
