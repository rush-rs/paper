...
The left recursion causes the \qVerb{Expression} rule to include the same start tokens as the \qVerb{integer} rule since an \qVerb{Expression} can also start with an \qVerb{integer}~\cite[p.~85]{Watson2017}.
