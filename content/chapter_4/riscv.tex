...
\begin{wrapfigure}{R}{0.42\textwidth}
	...
	\begin{tikzpicture}[node distance=5mm]
		\node(stack)[
			...
			\nodepart{one}{{\texttt{\footnotesize 24(sp\textsubscript{0})}} fp$_0$}
			\nodepart{two}{{\texttt{\footnotesize 16(sp\textsubscript{0})}} ra$_0$}
			\nodepart{three}{{\texttt{\footnotesize 08(sp\textsubscript{0})}} argument 2}
			\nodepart{four}{{\texttt{\footnotesize ~0(sp\textsubscript{0})}} argument 1}
			\nodepart{five}{{\texttt{\footnotesize ~8(sp\textsubscript{1})}} fp$_1$}
			\nodepart{six}{{\texttt{\footnotesize ~0(sp\textsubscript{1})}} ra$_1$}
		};
