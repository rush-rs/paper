...
It is to be noted that the type cannot be used explicitly, meaning syntax like \qVerb{let a: ! = exit(0)} is illegal as it would not create any practical benefits.
...
\begin{table}[h]
	\centering
    \caption{Lines of code of the project's components in commit \TODO{show commit here}}\label{tbl:rush_loc_components}
