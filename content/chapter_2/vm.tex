...
If the prelude was omitted, the \qVerb{main} function would instead contain these instructions since it is executed at program start.
...
\Lirsting[caption={VM Instructions for the minimal Pointer Example}, label={lst:rush_pointer_simple_vm_instructions}, fancyvrb={numbers=right}, wrap=R, wrap width={.27\textwidth}]{listings/vm_instructions_simple_pointer.s}
