...
example, there is a valid \texttt{main} function which complies with the previously explained constraints. Now, the analyzer traverses the
...
\Lirsting[ranges={3-5}, caption={Redundant \texttt{while} Loop Inside a rush Program}]{listings/constant_true_while.rush}
...
\Lirsting[ranges={2-4}, caption={\texttt{while} Loop Inside a rush Program Which Never Iterates}]{listings/constant_false_while.rush}
