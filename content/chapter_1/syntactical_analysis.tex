...
% TODO: fix gobble
\TSListing[first line=172, last line=201, float=h, label={lst:rush_tok_prec}, caption={Token Precedences in rush \TODO{necessary to show full method?}}]{deps/rush/crates/rush-parser/src/token.rs}
