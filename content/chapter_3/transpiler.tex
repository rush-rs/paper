...
\begin{minipage}{.45\textwidth}
	\center
	\Lirsting[caption={C transpiler output of rush program in Listing~\ref{lst:rush_transpiler_block}.}, label={lst:c_transpiler_block}, float=H]{listings/generated/rush_simple_scope.c}
	\vspace{.1cm}
\end{minipage}
