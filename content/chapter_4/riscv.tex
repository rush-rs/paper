...
\Lirsting[float=h, ranges={92-119,126-128,235-235}, caption={The \qVerb{call_expr} method in the \riscv{} rush compiler.}, label={lst:riscv_call_expr}]{deps/rush/crates/rush-compiler-risc-v/src/call.rs}
...
Here, the \qVerb{nth_param} method on the \qVerb{FloatRegister} enumeration is called.
