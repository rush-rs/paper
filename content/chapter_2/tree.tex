...
\Lirsting[ranges={6-13, 22-28}, path prefix={deps/rush}, wrap=L, label={lst:tree_value}, caption={Tree-Walking Interpreter: \qVerb{Value} and \qVerb{InterruptKind} Definitions}]{deps/rush/crates/rush-interpreter-tree/src/value.rs}
