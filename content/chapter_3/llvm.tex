...
A compiler writer must only implement the first step since the second step is entirely represented by LLVM\@.
...
The official API for LLVM is for \emph{C++} and \emph{C}.
