...
\begin{figure}[h]
	\begin{minipage}{.5\textwidth}
		\centering
        \TODO{replace the variables with parameters + add one other variable}
...
In the lines 312 until 316, the signature of the \texttt{main} function is created.
This signature is created inside an if-expression became the signature of the function differs dependinng on whether the compiler should create a \textttt{main} or a \texttt{\_start} function.
The latter is used if the compiler is used for cross-compilation\footnote{\TODO{here}} to another architecture.
