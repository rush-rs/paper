...
\TSListing[first line=10, last line=16, float=h, caption={The rush \Verb|Lexer| Struct Definition}, label={lst:lexer}]{deps/rush/crates/rush-parser/src/lexer.rs}
...
\TSListing[float=h, caption={Simplified \Verb|Token| Struct Definition}, label={lst:token_simple}]{listings/token_simple.rs}
