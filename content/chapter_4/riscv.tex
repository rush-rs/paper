...
This method returns the first available register from the register pool containing either integer registers\footnote{The \quote{i} in \qVerb{alloc_ireg} hints that it allocates integer registers}.
