...
For instance, if the value of variable \qVerb{num} in Figure~\ref{fig:rush_vm_linmem} was to be retrieved, the VM would need to access the storage cell with the index 4.
