...
\TODO{23.01.2023: @MikMuellerDev Continue proofreading here}
...
In order to understand how a program can be formulated using the LLVM IR, we again consider the rush program for calculating Fibonacci numbers.
...
\begin{wrapfigure}{R}{0.5\textwidth}
	...
	\begin{tikzpicture}[node distance=2cm]
		...
		% TODO: Use `arrow` instead of `relation` in order to remove spacing
...
Next, some library files in \texttt{/usr/lib/} are included.
